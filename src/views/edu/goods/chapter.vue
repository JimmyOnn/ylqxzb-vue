<template>
  <div class="app-container">
    ...
    <el-steps :active="2" process-status="wait" align-center style="margin-bottom: 40px">
      ...
      <el-step title="创建商品DIY描述"></el-step>
      <el-step title="最终发布"></el-step>
    </el-steps>

    <el-button type="primary" @click="OpenDialog">添加标题</el-button>
    <ul class="chanpterList">
      <li
        ...
        <p>{{ chapter.title }}
          <span class="acts">
            <el-button style="" type="text" @click="openVideo(chapter.id)">添加视频</el-button>
    ...
    <!--添加标题弹框-->
    <el-dialog :visible.sync="dialogChapterFormVisible" title="添加标题">
      <el-form :model="chapter" label-width="120px">
        <el-form-item label="标题信息">
          <el-input v-model="chapter.title"></el-input>
        </el-form-item>
        <el-form-item label="标题排序">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      removeVideo(id){
        this.$confirm('此操作将删除视频信息，是否继续？', '提示', {
      ...
      previous() {
        this.$router.push({path: '/goods/info/' + this.courseId})
      },
      next() {
        this.$router.push({path: '/goods/publish/' + this.courseId})
      },
      addChapter() {
